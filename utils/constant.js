export const fungsiBem = [
	{
		id: '1',
		title: 'Fungsi Representasi',
		desc: 'Mengemban mandat untuk menyuarakan aspirasi, kebutuhan, dan kepentingan mahasiswa dalam rangka menciptakan lingkungan akademik dan non-akademik yang kondusif.',
	},
	{
		id: '2',
		title: 'Fungsi Kordinasi',
		desc: 'Menjalin sinergi dengan organisasi mahasiswa lain di tingkat fakultas maupun universitas untuk mendukung terciptanya tata kelola organisasi kemahasiswaan yang efektif dan efisien.',
	},
	{
		id: '3',
		title: 'Fungsi Penggerak Sosial & Akademik',
		desc: 'Melaksanakan program kerja berbasis penelitian, pengabdian masyarakat, dan pengembangan kapasitas mahasiswa,  menjawab permasalahan di tingkat lokal, nasional, dan global.',
	},
	{
		id: '4',
		title: 'Fungsi Advokasi & Transformasi Sosial',
...
export const artikel = [
	{
		...
		gambar_headline: {
			url: '/artikel/studi-banding/presbem-unm-presbem-polnes.png',
			deskripsi: 'Foto: Presiden UNM & Presiden POLNES',
		},
		gambar_dua: {
			url: '/artikel/studi-banding/gambar-dua.png',
		},
		gambar_tiga: {
			url: '/artikel/studi-banding/gambar-tiga.png',
		},
		deskripsi_satu:
	...
	},
	{
		...
		gambar_dua: {
			url: '/artikel/advance-training/gambar-dua.png',
		},
		deskripsi_satu:
			'BEM UNM Selenggarakan National Advanced Training XVI: Redefinisi Nilai Demokrasi dan Kepemimpinan Politik Bangsa. Makassar, 20 November 2024 – Badan Eksekutif Mahasiswa (BEM) Universitas Negeri Makassar (UNM) sukses menyelenggarakan National Advanced Training ke-XVI dengan tema “The End of Democracy: Redefinisi Nilai Demokrasi dan Kepemimpinan Politik Bangsa”.',
		deskripsi_dua:
			'Acara yang berlangsung di Hotel La Macca pada 15-20 November 2024 ini diikuti oleh puluhan mahasiswa dari berbagai perguruan tinggi di Indonesia.Kegiatan selama enam hari ini bertujuan memberikan ruang diskusi dan pelatihan mendalam untuk menyiapkan mahasiswa sebagai calon pemimpin berkualitas. Tema yang diusung mencerminkan urgensi mahasiswa untuk memahami dan merespons tantangan demokrasi di Indonesia yang terus berkembang.Ketua Panitia, Syamsul Muarif, dalam sambutannya menyatakan bahwa tema ini sangat relevan dengan realitas terkini demokrasi di Indonesia. \n “Prinsip-prinsip demokrasi yang kita yakini saat ini menghadapi tantangan yang semakin kompleks. Dengan pelatihan ini, diharapkan peserta mampu memahami, menganalisis, dan mencari solusi terhadap dinamika demokrasi yang ada,” ujar Syamsul.Presiden BEM UNM, Hasrul, menekankan peran strategis mahasiswa sebagai agen perubahan yang akan menentukan masa depan bangsa. Kami berharap kegiatan ini menjadi wadah untuk belajar, berdiskusi, dan mengembangkan potensi diri. Mahasiswa harus mampu menjadi pemimpin yang tidak hanya memahami teori, tetapi juga mampu mempraktikkan nilai-nilai demokrasi yang sejati,"',
		deskripsi_tiga:
			'Sementara itu, Rektor UNM, Prof. Karta Jayadi, yang hadir memberikan motivasi kepada peserta, mengingatkan bahwa demokrasi di Indonesia saat ini menghadapi tantangan yang lebih fokus pada kuantitas daripada kualitas. Ia mengajak mahasiswa untuk menjadi agen perubahan yang mampu memperbaiki arah demokrasi bangsa.“Mahasiswa harus memulai dari diri sendiri untuk merancang masa depan yang lebih baik. Persahabatan, kolaborasi, dan nilai-nilai perubahan adalah modal utama untuk menghadapi tantangan masa depan,” tegasnya. Kegiatan ini tidak hanya menghadirkan diskusi interaktif tetapi juga materi-materi pelatihan strategis dari narasumber nasional yang kompeten di bidang demokrasi dan kepemimpinan. Dalam pelaksanaannya, peserta diajak untuk mengidentifikasi masalah demokrasi dan menawarkan gagasan solutif melalui diskusi kelompok dan simulasi kepemimpinan. Sebagai forum pelatihan tingkat nasional, National Advanced Training ini mendapat apresiasi positif dari peserta. Salah satu peserta, Dian Maulani dari Universitas Gadjah Mada, menyampaikan rasa bangga bisa terlibat dalam kegiatan ini.',
	},
	{
		id: 'seminar-riset-nasional',
		...
		gambar_dua: {
			url: '/artikel/workshop-riset/gambar-dua.png',
		},
		deskripsi_satu:
			'BEM UNM Gelar Seminar Riset Nasional: Bangun Budaya Ilmiah untuk Gerakan Mahasiswa Makassar, 6 Agustus 2024 – Badan Eksekutif Mahasiswa Universitas Negeri Makassar (BEM UNM) sukses menyelenggarakan Seminar Riset Nasional yang mengusung tema “Dari Opini Menjadi Fakta: Optimalisasi Riset dalam Membangun Gerakan yang Ilmiah”. Bertempat di Gedung Ballroom Teater lantai 3 Menara Phinisi UNM, acara ini menjadi tonggak penting dalam mendorong budaya riset di kalangan mahasiswa, yang selama ini dikenal sebagai masyarakat ilmiah sekaligus penggerak advokasi sosial. Presiden BEM UNM, Hasrul, dalam sambutannya menyampaikan harapan besar agar seminar ini mampu menjadi motor penggerak budaya riset yang kuat di kalangan mahasiswa. “Data menjadi senjata terbaik untuk menunjang keberhasilan gerakan teman-teman, dan data yang aktual berasal dari riset yang sistematis. Kami berharap seminar ini memperkaya pengetahuan serta membangun kesadaran mahasiswa bahwa setiap gerakan harus didasarkan pada fakta yang ilmiah,” tegas Hasrul.',
		deskripsi_dua:
			'Seminar ini menghadirkan tiga narasumber terkemuka yang memiliki pengalaman luas dalam riset dan advokasi, yaitu:Ki Darmaningtyas: Peneliti, penulis, dan pakar pendidikan yang dikenal atas kontribusinya dalam mengembangkan pemikiran kritis.Eko Prasetyo: Aktivis literasi dan penulis yang fokus pada isu-isu sosial dan pendidikan.Hikmawaty Sabar, S.Pd., M.Si.: Aktivis lingkungan dari WALHI Sulsel yang berpengalaman dalam mengawal isu sosial dan lingkungan.Kehadiran narasumber ini tidak hanya memberikan wawasan mendalam tentang metodologi riset, tetapi juga memotivasi mahasiswa untuk menerapkan hasil riset sebagai dasar dari gerakan yang mereka lakukan. Rektor UNM, Prof. Dr. Karta Jayadi, M.Sn., secara resmi membuka seminar ini dan memberikan apresiasi tinggi terhadap inisiatif BEM UNM. “Saya sangat mengapresiasi kegiatan ini. Di tengah berbagai kesibukan, terutama dalam rangka memperingati Dies Natalis UNM ke-63, BEM UNM mampu menyelenggarakan seminar yang relevan dan bermanfaat. Saya berharap seminar ini menghasilkan output yang konkret dan menjadi teladan bagi kampus-kampus lainnya,” ujar Prof. Karta Jayadi.',
		deskripsi_tiga:
