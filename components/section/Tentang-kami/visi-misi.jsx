const VisiMisi = () => {
	return (
		<div className="w-full flex flex-col justify-center items-center mb-10">
			<div className="flex w-full justify-center text-center text-[38px] mb-6">
				<div className="w-1/2">VISI</div>
				<div className="w-1/2">MISI</div>
			</div>
			<div className="bg-tetriary rounded-3xl flex w-full justify-center items-center gap-4 text-justify">
